...
- **favicon/**
  ...
  - [apple-touch-icon.png](./favicon/apple-touch-icon.png) *(7.8K)* - **180x180**
  - [favicon-16x16.png](./favicon/favicon-16x16.png) *(629B)* - **16x16**
  - [favicon-32x32.png](./favicon/favicon-32x32.png) *(1.3K)* - **32x32**
  - [favicon.ico](./favicon/favicon.ico) *(4.6K)* - **48x48**
  - [site.webmanifest](./favicon/site.webmanifest) *(426B)* - **Webmanifest config file**
- **favicon-dark/**
  - [android-chrome-192x192.png](./favicon-dark/android-chrome-192x192.png) *(7.7K)* - **192x192**
  - [android-chrome-512x512.png](./favicon-dark/android-chrome-512x512.png) *(23.3K)* - **512x512**
  - [apple-touch-icon.png](./favicon-dark/apple-touch-icon.png) *(7.5K)* - **180x180**
  - [favicon-16x16.png](./favicon-dark/favicon-16x16.png) *(603B)* - **16x16**
  - [favicon-32x32.png](./favicon-dark/favicon-32x32.png) *(1.3K)* - **32x32**
...
- **favicon-light/**
  - [android-chrome-192x192.png](./favicon-light/android-chrome-192x192.png) *(8.8K)* - **192x192**
  - [android-chrome-512x512.png](./favicon-light/android-chrome-512x512.png) *(26.4K)* - **512x512**
  - [apple-touch-icon.png](./favicon-light/apple-touch-icon.png) *(8.6K)* - **180x180**
  - [favicon-16x16.png](./favicon-light/favicon-16x16.png) *(694B)* - **16x16**
