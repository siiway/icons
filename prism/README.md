...
- **favicon/**
  ...
  - [apple-touch-icon.png](./favicon/apple-touch-icon.png) *(19.2K)* - **180x180**
  - [favicon-16x16.png](./favicon/favicon-16x16.png) *(636B)* - **16x16**
  - [favicon-32x32.png](./favicon/favicon-32x32.png) *(1.5K)* - **32x32**
  - [favicon.ico](./favicon/favicon.ico) *(5.1K)* - **48x48**
  - [site.webmanifest](./favicon/site.webmanifest) *(426B)* - **Webmanifest config file**
- **favicon-dark/**
  - [android-chrome-192x192.png](./favicon-dark/android-chrome-192x192.png) *(21.3K)* - **192x192**
  - [android-chrome-512x512.png](./favicon-dark/android-chrome-512x512.png) *(85.8K)* - **512x512**
  - [apple-touch-icon.png](./favicon-dark/apple-touch-icon.png) *(19.6K)* - **180x180**
  - [favicon-16x16.png](./favicon-dark/favicon-16x16.png) *(657B)* - **16x16**
...
- **favicon-light/**
  - [android-chrome-192x192.png](./favicon-light/android-chrome-192x192.png) *(21.1K)* - **192x192**
  - [android-chrome-512x512.png](./favicon-light/android-chrome-512x512.png) *(84.8K)* - **512x512**
  - [apple-touch-icon.png](./favicon-light/apple-touch-icon.png) *(19.4K)* - **180x180**
  - [favicon-16x16.png](./favicon-light/favicon-16x16.png) *(626B)* - **16x16**
